...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Administrations</h4>
            </div>
        ...
        @if(count($administrationsObjects) == 0)
            <div class="panel-body text-center">
                <h4>No Administrations Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($administrationsObjects as $administrations)
                        <tr>
                            <td>{{ $administrations->nom }}</td>
                            <td>{{ $administrations->tel }}</td>
                            <td>{{ $administrations->addresse }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('administrations.administrations.show', $administrations->id ) }}" class="btn btn-info" title="Show Administrations">
