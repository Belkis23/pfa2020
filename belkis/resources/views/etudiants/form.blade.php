...
<div class="form-group {{ $errors->has('nom') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="nom" type="text" id="nom" value="{{ old('nom', optional($etudiant)->nom) }}" minlength="1" placeholder="Enter nom here...">
...
<div class="form-group {{ $errors->has('tel') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="tel" type="text" id="tel" value="{{ old('tel', optional($etudiant)->tel) }}" minlength="1" placeholder="Enter tel here...">
...
<div class="form-group {{ $errors->has('addresse') ? 'has-error' : '' }}">
    ...
    <div class="col-md-10">
        <input class="form-control" name="addresse" type="text" id="addresse" value="{{ old('addresse', optional($etudiant)->addresse) }}" minlength="1" placeholder="Enter addresse here...">
